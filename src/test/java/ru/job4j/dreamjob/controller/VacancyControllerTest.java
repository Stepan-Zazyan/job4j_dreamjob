...
public class VacancyControllerTest {
    ...
    @Test
    public void whenUpdateThenGetNotUpdated() throws IOException {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
    ...
    @Test
    public void whenCreateSomeExceptionThrownThenGetErrorPageWithMessage() {
    ...
    @Test
    public void whenUpdateSomeExceptionThrownThenGetErrorPageWithMessage() {
        var expectedException = new RuntimeException("Failed to write file");
    ...
    @Test
    public void whenDeleteThenGetDeleted() {
    ...
    @Test
    public void whenDeleteThenNotGetDeleted() {
        var expectedMessage = "Вакансия с указанным идентификатором не найдена";
